![maven](https://img.shields.io/badge/python-3.9%2B-blue)![maven](https://img.shields.io/badge/nonebot-2.0.0-yellow)![maven](https://img.shields.io/badge/go--cqhttp-1.0.0-red)![maven](https://img.shields.io/badge/zhenxun-0.0.5.1-bgreen)
...
## 功能列表（梦落的功能）
<details>
<summary>梦落的功能</summary>

- [x] 色图
- [x] 天气查询（采用插件[nonebot-plugin-heweather](https://github.com/kexue-z/nonebot-plugin-heweather)）
- [x] 头像相关表情生成
- [x] steam游戏查询
- [x] 抽签
- [x] 王者荣耀出装
...
# 获取代码
git clone https://github.com/meng-luo/mengluo_bot.git
...
* 基于绪山真寻Bot修改的项目诞生
* 加入功能 色图，天气查询，头像相关表情生成，steam游戏查询，抽签，王者荣耀出装，番剧查询，表情包查找，网站工具，原神kfc语音，人生重开，塔罗牌
* 删除 原神黄历，原神今日素材，微博热搜，B站主播/UP/番剧订阅，天气查询，reimu搜索，go-cqhttp更新
...
[nonebot_plugin_analysis_bilibili][(https://github.com/mengshouer/nonebot_plugin_analysis_bilibili) [nonebot-plugin-heweather](https://github.com/kexue-z/nonebot-plugin-heweather)  
